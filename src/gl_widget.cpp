...
void GLWidget::initializeGL()            // после вызова конструктора, инициализация виджета
{
  ...
  m_texture = new QOpenGLTexture(QImage("data/alien.png"));        // Задаем текстуру пришельца
...
{
  m_screenSize.setWidth(w);   // Новая ширина окна
  m_screenSize.setHeight(h);  // Новая высота окна
}
