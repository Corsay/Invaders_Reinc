...
public:
  ...
  {
    assert(speed > 0 && "Speed must be more then ZERO!");
  }
  ...
  // Getters
  inline MovedGameEntity2D GetMovedEntity() const { return MovedGameEntity2D{ GetLifeEntity(), m_speed }; }
  ...
  // Logical operators
  bool operator == (MovedGameEntity2D const & obj)
  {
